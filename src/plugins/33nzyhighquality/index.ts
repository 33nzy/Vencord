...
export default definePlugin({
    ...
    getAudioBitrate() {
        ...
        console.log(`🎙️ [33nzy Plugin] Audio Bitrate: ${bitrate} kbps`);
        return bitrate;
    },
    ...
    start() {
        console.log("🎙️ [33nzy Studio Audio] ACTIVATED");
    ...
    stop() {
        console.log("🎙️ [33nzy Studio Audio] Deactivated");
    }
});
